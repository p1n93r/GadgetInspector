...
public class JavaDeserializationSourceDiscovery extends SourceDiscovery {
    ...
    public void discover(Map<ClassReference.Handle, ClassReference> classMap,
        ...
        final SerializableDecider serializableDecider = new JavaSerializableDecider(inheritanceMap);
